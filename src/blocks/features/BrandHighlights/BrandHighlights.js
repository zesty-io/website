...
const brandHighlights = [
  {
    ...
    title: 'Vertical Logo',
    subtitle: 'Vertical logo, the go-to variation for standard design applications.',
    width: 1,
  ...
  },
  {
    ...
    width: 1,
    subtitle: 'Horizontal logo used in environments that do not allow the vertical logo to work.',
  ...
  },
  {
    ...
    title: 'Brand Name',
    width: 1,
    subtitle: 'Brand name without the brand mark is used in envirnoments without spacing to acommodate the brand mark.',
