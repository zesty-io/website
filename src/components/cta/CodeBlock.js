...
export default function CodeBlock({text="npx create-next-app --example https://github.com/zesty-io/nextjs-starter"}) {
            ...
            <Paper 
                ...
                {showCopy && 
                    <Box sx={{
                        ...
                        <Icon>{icon}</Icon>
                        <span style={{marginLeft: '5px', fontSize: '12px'}}>{copyWords}</span> 
                </Box>}
            </Paper>
    );
}