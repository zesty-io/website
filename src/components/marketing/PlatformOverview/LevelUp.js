				...
				>
                    ...
                    content.level_up_features_cards?.data.map((item, index) => (
                        ...
                        <Card  sx={{px:4,py:5, minHeight:300}}>
                                ...
                                <Box sx={{width:"100%"}} component="img" src={`${item.icon_image?.data[0].url}?width=60`}/>
                            </Box>
                            <Typography sx={{mt:2,fontWeight:"bold", color: theme.palette.zesty.zestyOrange}}>
                                        {item.feature_name ||FillerContent.description}
                            </Typography>

                            <Typography sx={{mt:2, color: theme.palette.zesty.zestyZambezi, lineHeight:1.2}}>
