...
import { Box,Button, Divider, Container, Typography, Grid, Paper, Stack, List, ListItemText, ListItem, ListItemIcon, Chip, ListItemButton } from '@mui/material';
        ...
        <Container>
            <Box paddingY={3}>
                <Stack direction="row" alignItems="center" spacing={2} justifyContent="center">
                    <Button variant="contained" onClick={() => handleClick('https://www.zesty.io/meet/')}>Schedule an Onboarding Specialist</Button>
                    <Divider orientation="vertical" flexItem />
                    <Button variant="outlined" onClick={() => handleClick('https://accounts.zesty.io/instances/create')}>Launch a Project Now</Button>
...
const ScheduleOnboardingSpecialist = ({link='https://www.zesty.io/meet/'}) => <Card sx={{marginBottom: '16px' }}>
...
const ManagerDocumentation = () => <Card sx={{  }}>
...
<Typography variant="h6" style={{margin: '10px 20px'}}>FAQs for Marketers</Typography>
<Accordion>
  <AccordionSummary
...
const MarketerDocumentation = () => <Card sx={{  }}>
